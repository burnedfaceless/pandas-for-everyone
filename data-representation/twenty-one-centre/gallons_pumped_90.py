...
def main():
    ...
    well_id_to_query = 47  # Replace with the desired well ID
    ...
    try:
        ...
        query = f"SELECT pump, date_of_reading FROM well_readings WHERE well_id = {well_id_to_query} ORDER BY date_of_reading DESC LIMIT 90"
        ...
        plt.title('Gallons Pumped Per Last 90 Days Histogram')
